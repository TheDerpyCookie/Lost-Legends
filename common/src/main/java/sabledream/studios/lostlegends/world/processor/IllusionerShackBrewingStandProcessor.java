package sabledream.studios.lostlegends.world.processor;

import sabledream.studios.lostlegends.init.LostLegendsStructureProcessorTypes;
...
public final class IllusionerShackBrewingStandProcessor extends StructureProcessor
{
	...
	protected StructureProcessorType<?> getType() {
		return LostLegendsStructureProcessorTypes.ILLUSIONER_SHACK_BREWING_STAND_PROCESSOR;
	}
}
