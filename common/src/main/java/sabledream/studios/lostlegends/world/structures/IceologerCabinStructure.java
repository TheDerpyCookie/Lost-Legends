...
public final class IceologerCabinStructure extends Structure
{
	public static final MapCodec<IceologerCabinStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
		...
		).apply(instance, IceologerCabinStructure::new));
	...
	public Optional<StructurePosition> getStructurePosition(Context context) {
		...
		if (LostLegends.getConfig().generateIceologerCabinStructure == false) {
	...
	public StructureType<?> getType() {
		return LostLegendsStructureTypes.ICEOLOGER_CABIN_STRUCTURE;
	}
}