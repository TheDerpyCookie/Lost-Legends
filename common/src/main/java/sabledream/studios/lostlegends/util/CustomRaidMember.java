...
public final class CustomRaidMember
{
	...
	public static final String VILERWITCH_INTERNAL_NAME = "VILERWITCH";
	public static final int[] VILERWITCH_COUNT_IN_WAVE = {0, 0, 0, 0, 1, 0, 1, 1};
	public static Raid.Member VILERWITCH;
