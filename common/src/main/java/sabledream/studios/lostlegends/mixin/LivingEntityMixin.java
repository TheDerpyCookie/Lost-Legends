...
public class LivingEntityMixin
{
	...
	private ItemStack LostLegends_getStackInCustomSlots(
		...
		if (itemStackInHand.getItem() != Items.TOTEM_OF_UNDYING) {
			for (ModCompat compat : ModChecker.CUSTOM_EQUIPMENT_SLOTS_COMPATS) {
				ItemStack itemStack = compat.getEquippedItemFromCustomSlots(instance, LivingEntityMixin::LostLegends_isTotemOfUndying);
	...
	private static boolean LostLegends_isTotemOfUndying(ItemStack itemStack) {
