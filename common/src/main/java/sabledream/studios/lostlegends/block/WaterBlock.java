...
public abstract class WaterBlock extends Block implements Waterloggable
{

	public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;

	protected WaterBlock(Settings properties) {
		super(properties);
...
//	@Override
//	public boolean isPathfindable(BlockState state, BlockView reader, BlockPos pos, NavigationType PathComputationType) {
//		return false;
//	}
