package sabledream.studios.lostlegends.advancements.criterion;
...
public final class CompleteHideAndSeekGameCriterion extends AbstractCriterion<CompleteHideAndSeekGameCriterion.Conditions>
{
							 ...
							 Optional<ItemPredicate> item) implements AbstractCriterion.Conditions
	{
		...
		public static AdvancementCriterion<Conditions> any() {
			return LostLegendsCriteria.COMPLETE_HIDE_AND_SEEK_GAME.get().create(new CompleteHideAndSeekGameCriterion.Conditions(Optional.empty(), Optional.empty(), Optional.empty()));
		}

		public static AdvancementCriterion<Conditions> create(EntityPredicate.Builder playerPredicate) {
			return LostLegendsCriteria.COMPLETE_HIDE_AND_SEEK_GAME.get().create(new CompleteHideAndSeekGameCriterion.Conditions(Optional.of(EntityPredicate.contextPredicateFromEntityPredicate(playerPredicate)), Optional.empty(), Optional.empty()));
		}
