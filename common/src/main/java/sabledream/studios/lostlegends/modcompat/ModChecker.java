package sabledream.studios.lostlegends.modcompat;

import sabledream.studios.lostlegends.LostLegends;
import sabledream.studios.lostlegends.platform.Platform;
...
public final class ModChecker
{
	...
	public static void loadModCompat(String modId, Supplier<ModCompat> loader) {
		try {
			...
			LostLegends.getLogger().error("Failed to load compat with " + modId);
			e.printStackTrace();
		}
	}
}
