package sabledream.studios.lostlegends.entity.ai.goal.zombiehorse;
...
public final class ZombieHorseTrapTriggerGoal extends Goal
{
	...
	public void tick() {
		...
		((ZombieHorseEntityAccess) this.zombieHorse).LostLegends_setTrapped(false);
		...
		LostLegendsCriteria.ACTIVATE_ZOMBIE_HORSE_TRAP.get().trigger((ServerPlayerEntity) closestPlayer, lightningEntity, List.of());
	}
