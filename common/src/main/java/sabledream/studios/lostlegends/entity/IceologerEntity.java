...
public final class IceologerEntity extends SpellcastingIllagerEntity
{
	public IceologerEntity(EntityType<? extends IceologerEntity> entityType, World world) {
		...
		if (LostLegends.getConfig().enableIceologer == false && this.getWorld().isClient() == false) {
			this.discard();
		}
	...
	public SoundEvent getCelebratingSound() {
		return LostLegendsSoundEvents.ENTITY_ICEOLOGER_AMBIENT.get();
	}
	...
	@Override
	public void tick() {
		if (LostLegends.getConfig().enableIceologer == false) {
			this.discard();
		}
	...
	protected SoundEvent getDeathSound() {
		return LostLegendsSoundEvents.ENTITY_ICEOLOGER_DEATH.get();
	}

	protected SoundEvent getHurtSound(DamageSource source) {
		return LostLegendsSoundEvents.ENTITY_ICEOLOGER_HURT.get();
	}

	protected SoundEvent getCastSpellSound() {
		return LostLegendsSoundEvents.ENTITY_ICEOLOGER_CAST_SPELL.get();
	}
	...
	private class SummonIceChunkGoal extends CastSpellGoal
	{
		...
		protected SoundEvent getSoundPrepare() {
			return LostLegendsSoundEvents.ENTITY_ICEOLOGER_PREPARE_SUMMON.get();
		}
	...
	public final class SlowTargetGoal extends CastSpellGoal
	{
		...
		@Override
		protected SoundEvent getSoundPrepare() {
			return LostLegendsSoundEvents.ENTITY_ICEOLOGER_PREPARE_SLOWNESS.get();
		}
