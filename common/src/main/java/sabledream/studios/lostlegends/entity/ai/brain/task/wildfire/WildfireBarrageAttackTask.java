package sabledream.studios.lostlegends.entity.ai.brain.task.wildfire;

import sabledream.studios.lostlegends.entity.WildfireEntity;
import sabledream.studios.lostlegends.entity.WildfireShieldDebrisEntity;
...
public final class WildfireBarrageAttackTask extends MultiTickTask<WildfireEntity>
{
	...
	public WildfireBarrageAttackTask() {
		super(ImmutableMap.of(
			...
			LostLegendsMemoryModuleTypes.WILDFIRE_BARRAGE_ATTACK_COOLDOWN.get(), MemoryModuleState.VALUE_ABSENT
	...
	protected boolean shouldKeepRunning(ServerWorld world, WildfireEntity wildfire, long time) {
		...
		return nearestVisibleTargetablePlayer == null
			   ...
			   || !wildfire.getBrain().isMemoryInState(LostLegendsMemoryModuleTypes.WILDFIRE_SHOCKWAVE_ATTACK_COOLDOWN.get(), MemoryModuleState.VALUE_ABSENT);
	}
