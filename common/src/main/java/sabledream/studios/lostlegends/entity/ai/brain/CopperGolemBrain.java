...
import sabledream.studios.lostlegends.entity.ai.brain.task.coppergolem.CopperGolemLocateButtonTask;
import sabledream.studios.lostlegends.entity.ai.brain.task.coppergolem.CopperGolemPressButtonTask;
import sabledream.studios.lostlegends.entity.ai.brain.task.coppergolem.CopperGolemSpinHeadTask;
import sabledream.studios.lostlegends.entity.ai.brain.task.coppergolem.CopperGolemTravelToButtonTask;
...
public final class CopperGolemBrain
{
	...
	private static void addCoreActivities(Brain<CopperGolemEntity> brain) {
		brain.setTaskList(Activity.CORE,
			...
			ImmutableList.of(
				...
				new TemptationCooldownTask(LostLegendsMemoryModuleTypes.COPPER_GOLEM_SPIN_HEAD_COOLDOWN.get()),
				new TemptationCooldownTask(LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get())
			)
		);
	}
	...
	private static void addPressButtonActivities(
		...
		brain.setTaskList(
			LostLegendsActivities.COPPER_GOLEM_PRESS_BUTTON.get(),
			ImmutableList.of(
			...
			ImmutableSet.of(
				...
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_IS_OXIDIZED.get(), MemoryModuleState.VALUE_ABSENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get(), MemoryModuleState.VALUE_ABSENT)
			)
		);
	}
	...
	private static void addSpinHeadActivities(
		...
		brain.setTaskList(
			LostLegendsActivities.COPPER_GOLEM_SPIN_HEAD.get(),
			ImmutableList.of(
			...
			ImmutableSet.of(
				Pair.of(MemoryModuleType.TEMPTING_PLAYER, MemoryModuleState.VALUE_ABSENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_IS_OXIDIZED.get(), MemoryModuleState.VALUE_ABSENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_BUTTON_POS.get(), MemoryModuleState.VALUE_ABSENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_SPIN_HEAD_COOLDOWN.get(), MemoryModuleState.VALUE_ABSENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get(), MemoryModuleState.VALUE_PRESENT)
			)
		);
	}
	...
	private static void addIdleActivities(Brain<CopperGolemEntity> brain) {
		brain.setTaskList(
			...
			ImmutableSet.of(
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_IS_OXIDIZED.get(), MemoryModuleState.VALUE_ABSENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_SPIN_HEAD_COOLDOWN.get(), MemoryModuleState.VALUE_PRESENT),
				Pair.of(LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get(), MemoryModuleState.VALUE_PRESENT)
			)
		);
	}
	...
	public static void setSpinHeadCooldown(CopperGolemEntity copperGolem) {
		copperGolem.getBrain().remember(LostLegendsMemoryModuleTypes.COPPER_GOLEM_SPIN_HEAD_COOLDOWN.get(), SPIN_HEAD_COOLDOWN_PROVIDER.get(copperGolem.getRandom()));
	}

	public static void setPressButtonCooldown(CopperGolemEntity copperGolem) {
		copperGolem.getBrain().remember(LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get(), PRESS_BUTTON_COOLDOWN_PROVIDER.get(copperGolem.getRandom()));
	}

	public static void setPressButtonCooldown(CopperGolemEntity copperGolem, UniformIntProvider cooldown) {
		copperGolem.getBrain().remember(LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get(), cooldown.get(copperGolem.getRandom()));
	}
	...
	static {
		SENSORS = List.of(
			LostLegendsMemorySensorType.COPPER_GOLEM_TEMPTATIONS.get(),
			LostLegendsMemorySensorType.COPPER_GOLEM_SPECIFIC_SENSOR.get()
		);
		MEMORY_MODULES = List.of(
			...
			LostLegendsMemoryModuleTypes.COPPER_GOLEM_IS_OXIDIZED.get(),
			LostLegendsMemoryModuleTypes.COPPER_GOLEM_BUTTON_POS.get(),
			LostLegendsMemoryModuleTypes.COPPER_GOLEM_SPIN_HEAD_COOLDOWN.get(),
			LostLegendsMemoryModuleTypes.COPPER_GOLEM_PRESS_BUTTON_COOLDOWN.get()
		);
