...
import sabledream.studios.lostlegends.client.render.entity.animation.TuffGolemAnimations;
...
public final class TuffGolemEntity extends GolemEntity implements AnimatedEntity
{
	...
	private SoundEvent getGlueOnSound() {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_GLUE_ON.get();
	}
	...
	private SoundEvent getGlueOffSound() {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_GLUE_OFF.get();
	}
	...
	public SoundEvent getMoveSound() {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_MOVE.get();
	}
	...
	private SoundEvent getRepairSound() {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_REPAIR.get();
	}
	...
	public SoundEvent getWakeSound() {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_WAKE.get();
	}
	...
	public SoundEvent getSleepSound() {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_SLEEP.get();
	}
	...
	protected SoundEvent getHurtSound(DamageSource source) {
		return LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_HURT.get();
	}
	...
	protected void playStepSound(
		...
		this.playSound(LostLegendsSoundEvents.ENTITY_TUFF_GOLEM_STEP.get(), blockSoundGroup.getVolume(), 0.75F + this.getRandom().nextFloat() * 0.15F);
	}
	...
	@Override
	public void tick() {
		if (this.getWorld().isClient() == false && LostLegends.getConfig().enableTuffGolem == false) {
			this.discard();
		}
