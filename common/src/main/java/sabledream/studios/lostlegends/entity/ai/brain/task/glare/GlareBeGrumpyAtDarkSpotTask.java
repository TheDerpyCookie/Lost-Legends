...
public final class GlareBeGrumpyAtDarkSpotTask extends MultiTickTask<GlareEntity>
{
	...
	public GlareBeGrumpyAtDarkSpotTask() {
		super(
			Map.of(
				LostLegendsMemoryModuleTypes.GLARE_DARK_SPOT_POS.get(), MemoryModuleState.VALUE_PRESENT
			), MAX_GRUMPY_TICKS
		);
	}
	...
	protected void finishRunning(ServerWorld world, GlareEntity glare, long time) {
		...
		glare.getBrain().forget(LostLegendsMemoryModuleTypes.GLARE_DARK_SPOT_POS.get());
