...
import sabledream.studios.lostlegends.entity.ai.goal.melongolem.MelonGolemHopGoal;
import sabledream.studios.lostlegends.entity.ai.goal.melongolem.MelonGolemProjectileAttackGoal;
...
public class MelonGolemEntity extends GolemEntity implements RangedAttackMob
{
	...
	goalSelector.add(6, new ActiveTargetGoal<>(this, MobEntity.class, 10, true, false, (entity) -> entity instanceof Monster && !(entity instanceof TropicalSlimeEntity)));
	...
	protected void initDataTracker(DataTracker.Builder builder) {
		...
		builder.add(MELON_EQUIPPED, (byte) 16);
		builder.add(SHOOTING_TICKS, 0);
	}
	...
	public void shootAt(LivingEntity target, float distanceFactor) {
		...
		playSound(LostLegendsSoundEvents.MELON_GOLEM_ATTACK.get(), 1.0F, 1.0F / (getRandom().nextFloat() * 0.4F + 0.8F));
	...
	public void jump() {
		...
		setVelocity(vec3.x, getJumpVelocity(), vec3.z);
		velocityDirty = true;
	}
