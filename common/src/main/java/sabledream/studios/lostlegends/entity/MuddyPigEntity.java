...
import sabledream.studios.lostlegends.entity.ai.goal.muddypig.MuddyPigMoveToTargetGoal;

public class MuddyPigEntity extends LostLegendsBasePigEntity
{
