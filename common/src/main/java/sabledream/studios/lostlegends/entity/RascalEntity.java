...
import sabledream.studios.lostlegends.client.render.entity.animation.RascalAnimations;
import sabledream.studios.lostlegends.client.render.entity.animation.animator.context.AnimationContextTracker;
import sabledream.studios.lostlegends.entity.ai.brain.RascalBrain;
import sabledream.studios.lostlegends.entity.animation.AnimatedEntity;
import sabledream.studios.lostlegends.entity.pose.RascalEntityPose;
...
public final class RascalEntity extends PassiveEntity implements AnimatedEntity
{
	...
	@Override
	public void tick() {
		if (LostLegends.getConfig().enableRascal == false) {
			this.discard();
		}
	...
	public SoundEvent getNodSound() {
		return LostLegendsSoundEvents.ENTITY_RASCAL_NOD.get();
	}
	...
	public SoundEvent getRewardSound() {
		return LostLegendsSoundEvents.ENTITY_RASCAL_REWARD.get();
	}
	...
	public SoundEvent getBadRewardSound() {
		return LostLegendsSoundEvents.ENTITY_RASCAL_REWARD_BAD.get();
	}
	...
	protected SoundEvent getAmbientSound() {
		return LostLegendsSoundEvents.ENTITY_RASCAL_AMBIENT.get();
	}
	...
	protected SoundEvent getHurtSound(DamageSource source) {
		return LostLegendsSoundEvents.ENTITY_RASCAL_HURT.get();
	}
	...
	public SoundEvent getDisappearSound() {
		return LostLegendsSoundEvents.ENTITY_RASCAL_DISAPPEAR.get();
	}
	...
	public SoundEvent getReappearSound() {
		return LostLegendsSoundEvents.ENTITY_RASCAL_REAPPEAR.get();
	}
