...
public final class IceologerEntityRenderer<T extends SpellcastingIllagerEntity> extends IllagerEntityRenderer<T>
{
	public IceologerEntityRenderer(Context context) {
		super(context, new IllagerEntityModel<>(context.getPart(LostLegendsEntityModelLayer.ICEOLOGER_LAYER)), 0.5F);
	...
	public Identifier getTexture(T entity) {
		return LostLegends.makeID("textures/entity/illager/iceologer.png");
	}
}