...
import sabledream.studios.lostlegends.client.render.entity.model.IceologerIceChunkModel;
...
{
	private static final Identifier TEXTURE = LostLegends.makeID("textures/entity/illager/ice_chunk.png");
	private final IceologerIceChunkModel<IceologerIceChunkEntity> model;

	public IceologerIceChunkRenderer(Context context) {
		super(context);
		this.model = new IceologerIceChunkModel(context.getPart(LostLegendsEntityModelLayer.ICEOLOGER_ICE_CHUNK_LAYER));
	}
