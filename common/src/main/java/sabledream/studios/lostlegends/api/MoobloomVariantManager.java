...
public final class MoobloomVariantManager extends JsonDataLoader
{
	...
	private static final MoobloomVariant DEFAULT_MOOBLOOM_VARIANT = new MoobloomVariant("buttercup", LostLegendsBlocks.BUTTERCUP.get(), LostLegendsTags.HAS_MOOBLOOMS);
